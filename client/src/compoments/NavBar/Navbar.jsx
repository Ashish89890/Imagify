...
const Navbar = () => {
    ...
    const { user } = React.useContext(AppContext);
     const { LoginShow ,setLoginShow,logOut,credits}=  React.useContext(AppContext)
          ...
          <div>
              {user ?
                  <div className='flex items-center gap-2 sm:gap-3'>
                      ...
                      text-gray-600'>Credits left: {credits}</p>
                      </button>
                      <p className='text-gray-600 max-sm:  pl-4'>Hi , {user} </p>
